import{r as y,_ as I,C as S,a as F,E as ae,o as K,F as Re,g as A,b as Fe,v as Ke,i as $e,c as je,d as N,e as h,u as U,f as G,h as J,j as se,k as z}from"./dateUtils.Dmt2P8ZV.js";import"./index.DgOxCJIz.js";const ce="@firebase/installations",$="0.6.20";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function on(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===m.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(ne(n)):e.onMessageHandler.next(ne(n)));const o=n.data;zt(o)&&o[_t]==="1"&&await tn(e,n.messageType,o)}const oe="@firebase/messaging",ie="0.12.24";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
